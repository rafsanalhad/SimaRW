            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                <li class="nav-item dropdown">
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="{{ url('/assets/images/profile/user-1.jpg') }}" alt="" width="35" height="35"
            ...
            <div class="modal-body">
                <div class="pengumumanSearchWrapper">
                    <div class="input-group mb-3">
                        ...
                        <input type="month" class="form-control" id="searchPengumuman" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                </div>
            ...
            $.ajax({
                ...
                let pengumumanHTML = '';
                    for (let i = 0; i < filteredData.length; i++) {
                        ...
                        pengumumanHTML +=
                            '<div class="row"> <div class="col-4"> Tanggal </div> <div class="col-6"> : ' + filteredData[i]
                            .tanggal_pengumuman + '</div> </div>';
                        pengumumanHTML +=
                            '<div class="row"> <div class="col-4"> Jam </div> <div class="col-6"> : ' + filteredData[i]
                            .jam_pengumuman + '</div> </div>';
                        pengumumanHTML +=
                            '<div class="row"> <div class="col-4"> Tempat </div> <div class="col-6"> : ' + filteredData[i]
