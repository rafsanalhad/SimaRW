            ...
            <table class="table" id='table_pengaduan'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ut fringilla magna, non molestie enim. Donec convallis sagittis lacinia. Morbi eu semper </td>
                        <td>
                            <div style="display: flex;">
                            <a href="" class="btn btn-danger">Tolak</a>
                            <a href="" onclick='showTambahBansos()' class="btn btn-success">Terima</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <table class="table" id='table_pengaduan'>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a class="btn btn-success">Verifikasi</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
