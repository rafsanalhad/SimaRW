            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem; height: 540px;">
                        ...
                        <img class="card-img-top" src="{{ asset('storage/' . $umkm->gambar_umkm) }}" alt="Card image cap">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-warning" onclick="modalEditUmkm({{ $umkm->umkm_id }})">Edit</a>
                            <a href="#" class="btn btn-danger" onclick="hapusData({{ $umkm->umkm_id }})">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('createUmkm') }}" id="form_edit" method="POST" class="form"
                            ...
                            <div class="row d-flex align-items-center mt-3">
                                ...
                                <div class="col-6">
                                    <select class="form-control" id="pemilik_umkm_edit" name="pemilik_umkm" id="">
                            ...
                            <div class="row d-flex align-items-center mt-3">
                                ...
                                <div class="col-6">
                                    <textarea name="deskripsi_umkm" class="form-control" id="deskripsi_umkm_edit"
