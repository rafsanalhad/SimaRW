...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="card" style="width: 18rem; height: 540px;">
                                <img class="card-img-top" style="height: 250px;"
                                    src="{{ asset('storage/' . $kegiatan->foto_kegiatan) }}" alt="Card image cap">
                                <div class="card-body">
                            ...
                            <form action="{{ url('/admin/kegiatan-warga') }}" id="form_edit" method="POST" class="form"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                        onclick=hideModalTambahKegiatan()>Tutup</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        const modalEditKegiatan = (idKegiatan) => {
            $.ajax({
                url: '/admin/kegiatan-warga/edit/' + idKegiatan,
                type: 'GET',
                dataType: 'json',
                success(data) {
                    console.log(data)
            ...
            $('#form_edit').attr('action', '/admin/kegiatan-warga/update/' + idKegiatan);
        ...
        const hapusData = (idKegiatan) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/kegiatan-warga/delete/' + idKegiatan,
                        type: 'GET',
                        success: function() {
                            Swal.fire({
