                ...
                <form action="/rt/kelola-iuran" method="POST" class="form-horizontal row" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input placeholder="Masukkan Jumlah Pengeluaran" type="text" class="form-control"
                    ...
                    <div class="col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea placeholder="Masukkan detail pengeluaran" class="form-control" id="pengaduan_warga"
                                    name="keterangan_pengeluaran" value="{{ old('detail_pengeluaran') }}" rows="7px" required></textarea>
                                <small class="form-text text-danger"></small>
                            </div>
                        </div>
                    </div>
